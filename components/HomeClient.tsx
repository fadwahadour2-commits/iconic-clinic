...
Question: ${bookingData.question}`;
  ...
  return (
    ...
    >
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[200] focus:rounded-full focus:bg-white focus:px-5 focus:py-3 focus:text-sm focus:font-medium focus:text-black focus:shadow-lg"
      >
        {isArabic ? "الانتقال إلى المحتوى" : "Aller au contenu principal"}
      </a>
      ...
      <header className="fixed left-0 top-0 z-50 w-full">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <div className="rounded-full border border-white/20 bg-white/10 p-1">
              ...
              <button
                ...
                aria-label="عرض الموقع بالعربية"
                className={`rounded-full px-3 py-1.5 text-xs md:text-sm ${
        ...
        {mobileMenuOpen && (
          <nav
            id="mobile-nav"
            className="mx-auto mt-2 flex max-w-7xl flex-col gap-1 rounded-3xl border border-white/20 bg-black/90 p-4 text-sm text-white shadow-xl backdrop-blur-md md:hidden"
          >
            <Link
              href="/services"
      ...
      >
        <Image
          src="/clinic.jpg"
          alt="Iconic Clinic à Mohammedia — clinique de médecine esthétique du Dr Ahmed Marzouk"
          fill
          priority
      ...
      <section id="doctor" className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div className="relative h-[520px] overflow-hidden rounded-[2rem] shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
            <Image
              src="/doctor.jpg"
              alt="Dr Ahmed Marzouk, médecin esthétique à Iconic Clinic Mohammedia"
              fill
              className="object-cover"
            />
          ...
          <div className="grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
            <div className="overflow-hidden rounded-[2rem] border border-black/5 bg-white shadow-[0_18px_50px_rgba(0,0,0,0.05)]">
              <iframe
                ...
                title="Localisation d'Iconic Clinic sur Google Maps"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
      ...
      <div className="fixed bottom-24 right-6 z-50 flex flex-col gap-4">
        <div className="group relative flex items-center justify-end animate-[fadeUp_0.6s_ease_0.2s_both]">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Suivre Iconic Clinic sur Instagram"
          ...
          >
            <FaInstagram className="text-white group-hover:text-pink-400" aria-hidden="true" />
          </a>
        </div>
        ...
        <div className="group relative flex items-center justify-end animate-[fadeUp_0.6s_ease_0.4s_both]">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Suivre Iconic Clinic sur Facebook"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/30 bg-white/20 shadow backdrop-blur transition hover:scale-110"
          >
            <FaFacebook className="text-white group-hover:text-blue-400" aria-hidden="true" />
          </a>
        </div>
        ...
        <div className="group relative flex items-center justify-end animate-[fadeUp_0.6s_ease_0.6s_both]">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Suivre Iconic Clinic sur TikTok"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/30 bg-white/20 shadow backdrop-blur transition hover:scale-110"
          >
            <FaTiktok className="text-white group-hover:text-black" aria-hidden="true" />
          </a>
        </div>
      </div>
          ...
          <div className="w-full max-w-2xl rounded-[2rem] bg-white p-6 shadow-2xl md:p-8">
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                ...
                aria-label={isArabic ? "إغلاق نافذة الحجز" : "Fermer la fenêtre de réservation"}
